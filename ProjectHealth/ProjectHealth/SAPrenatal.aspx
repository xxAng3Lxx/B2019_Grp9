<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SAPrenatal.aspx.cs" Inherits="ProjectHealth.SAPrenatal" %>
...
<head runat="server">
   <title>Health Center ADMIN</title>
      <link href="css/SAPrenatal.css" rel="stylesheet" />
</head>
<body>
        ...
        <div class="content">
            ...
            <div class="fillup">
                ...
                <asp:TextBox ID="txtcontact" runat="server" class="txtcontact" ></asp:TextBox>
                 ...
                 <asp:TextBox ID="txtbrgy" runat="server" class="txtbrgy" Enabled="True" >Staana</asp:TextBox>
