...
{
    public partial class SACheckup : System.Web.UI.Page
    {
        ...
        void LoadRecord()
        {
            SqlCommand comm = new SqlCommand("select * from TableCHECKUP WHERE Brgy='Staana' ORDER BY date ASC ", con);
        ...
        protected void Button11_Click(object sender, EventArgs e)
        {
           ...
           // con.Open();
            //SqlCommand comm = new SqlCommand("Insert into TableCHECKUP values('" + txtpatient.Text + "','" + txtaddress.Text + "','" + txtdate.Text + "','" + txtcontact.Text + "','" + txtgender.SelectedValue + "','" + int.Parse(txtage.Text) + "','" + txtillness.SelectedValue + "','" + txtothers.Text + "','" + txtbgry.Text + "')", con);
