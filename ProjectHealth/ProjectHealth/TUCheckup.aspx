<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TUCheckup.aspx.cs" Inherits="ProjectHealth.TUCheckup" %>
...
<head runat="server">
   <title>Tuktukan ADMIN</title>
      <link href="css/TUCheckup.css" rel="stylesheet" />
</head>
<body>
    ...
    <div class="nav">
       ...
       <asp:Label ID="Label11" runat="server" class="content tagline1" Text="Patient Record"></asp:Label>
        ...
        <div class="scroll">
           ...
           <asp:TextBox ID="txtbgry" runat="server" class="txtbgry" Enabled="True" >Tuktukan</asp:TextBox>
