<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="checkup.aspx.cs" Inherits="ProjectHealth.checkup" %>
...
<body>
   ...
   <div class="content">
       ...
       <asp:DropDownList ID="DropDownList1" runat="server" class="dropdown" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
       ...
       <asp:Button ID="Button10" runat="server" OnClick="Button10_Click" Text="Load" class="refresh" />
       ...
       <div class="fillup">
           ...
           <asp:DropDownList ID="txtbgry" runat="server" class="txtbgry" >
               <asp:ListItem>Staana</asp:ListItem>
               <asp:ListItem>Tuktukan</asp:ListItem>
               <asp:ListItem>NorthSignal</asp:ListItem>
           </asp:DropDownList>
           ...
           <asp:Label ID="Label1" runat="server" class="patient"      Text="Fullname:"></asp:Label>
           <asp:Label ID="Label2" runat="server" class="address"      Text="Address:"></asp:Label>
           <asp:Label ID="Label3" runat="server" class="age"      Text="Age:"></asp:Label>
           <asp:Label ID="Label4" runat="server" class="contact"      Text="Contact:"></asp:Label>
           <asp:Label ID="Label5" runat="server" class="date"      Text="Reservation:"></asp:Label>

           <asp:Label ID="Label6" runat="server" class="gender"      Text="Gender:"></asp:Label>
           <asp:Label ID="Label7" runat="server" class="brgy"      Text="Barangay:"></asp:Label>
           <asp:Label ID="Label8" runat="server" class="illness"      Text="Illness:"></asp:Label>
